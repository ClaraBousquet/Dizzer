 ...
 */
final class Version20240117101057 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE album ADD artist_id INT NOT NULL, DROP album_artist, DROP type');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE album ADD album_artist VARCHAR(255) NOT NULL, ADD type VARCHAR(255) NOT NULL, DROP artist_id');
    }
}
